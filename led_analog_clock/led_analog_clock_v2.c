...
led_charlieplex_port_t led_analog_clock_v2_ports[] = {
...
led_charlieplex_led_t led_analog_clock_v2_leds[] = {
  { "AA1", 0, 0, 2, 4 },
  { "AB1", 0, 0, 2, 5 },
  { "AC1", 0, 0, 2, 6 },
  { "AD1", 0, 0, 2, 7 },
...
led_charlieplex_t led_analog_clock_v2 = {
  0,
  led_analog_clock_v2_ports,
  led_analog_clock_v2_leds
};
